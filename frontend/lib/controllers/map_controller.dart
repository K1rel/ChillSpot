...
class MapSearchController {
  ...
  Future<void> calculateRoute(LatLng start, LatLng end) async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse(
          'https://api.mapbox.com/directions/v5/mapbox/walking/${start.longitude},${start.latitude};${end.longitude},${end.latitude}?geometries=polyline&access_token=pk.eyJ1IjoiazFyZWwiLCJhIjoiY204bjIyY3RnMG1qZzJqcGw3Z25hNHpqcCJ9.8v0wmrd4rnTBb6-C6nuxJQ',
        ),
      );
